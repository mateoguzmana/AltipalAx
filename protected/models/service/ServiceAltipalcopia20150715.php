...
class ServiceAltipal extends CActiveRecord {
    ...
    public function ConsultaDatosGlobal() {
       ...
       public function ConsultaDatosGlobalDocumento($tipoDocumento) 
       {
        ...
        //Los pasamos a estado dos que se estan transmitiendo
    ...
    public function ConsultaHabilitarEnvios() 
       {
  $consulta = new Multiple();
        $sql = "Update `transaccionesax` SET  EstadoTransaccion = '0' WHERE  EstadoTransaccion = '2'";
        $consulta->multiQuery($sql);        
    }
    ...
    public function getTransferenciaConsignacionDescripcion($idTransfereciaConsignacion) {
  ...
  $sql = "SELECT * FROM `pedidos` as pe join transaccionesax as transax on pe.IdPedido=transax.IdDocumento WHERE pe.IdPedido = '$idPedido' AND transax.CodTipoDocumentoActivity = '$idTipoDoc'  ";
   ...
   public function  getInfoChequeDetalle($IdReciboCajaFactura,$NoCheque,$agencia){
          ...
          try {
            $sql = "SELECT caja.CuentaCliente,reci.NumeroFactura,cheque.Valor,cheque.ValorTotal FROM reciboscaja as caja join `reciboscajafacturas` as reci on caja.Id=reci.IdReciboCaja join reciboscheque as cheque on reci.Id=cheque.IdReciboCajaFacturas  where  caja.Id = '$IdReciboCajaFactura' and cheque.NroCheque = '$NoCheque'";
