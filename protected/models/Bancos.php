 ...
 */
class Bancos extends AgenciaActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('CodBanco, IdentificadorBanco', 'numerical', 'integerOnly'=>true),
			array('Nombre', 'length', 'max'=>70),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('CodBanco, Nombre, IdentificadorBanco', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'cuentasbancariases' => array(self::HAS_MANY, 'Cuentasbancarias', 'CodBanco'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'CodBanco' => 'Cod Banco',
			'Nombre' => 'Nombre',
			'IdentificadorBanco' => 'Identificador Banco',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('IdentificadorBanco',$this->IdentificadorBanco);
