...
/**
 * This is the model class for table "kitdescripciontransferencia".
 *
 * The followings are the available columns in table 'kitdescripciontransferencia':
 * @property integer $Id
 * @property integer $IdDescripcionTransferencia
 ...
 */
class Kitdescripciontransferencia extends AgenciaActiveRecord {
    ...
    public function tableName() {
        return 'kitdescripciontransferencia';
    }
    ...
    public function rules() {
        ...
        return array(
            array('IdDescripcionTransferencia, CodigoListaMateriales, CodigoArticuloComponente, Nombre, CodigoUnidadMedida, CodigoTipo, PrecioVentaBaseVariante', 'required'),
            array('IdDescripcionTransferencia, Cantidad', 'numerical', 'integerOnly' => true),
            ...
            array('PrecioVentaBaseVariante', 'length', 'max' => 10),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('Id, IdDescripcionTransferencia, CodigoListaMateriales, CodigoArticuloComponente, Nombre, CodigoUnidadMedida, CodigoTipo, Fijo, Opcional, Cantidad, PrecioVentaBaseVariante', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'Id' => 'ID',
            'IdDescripcionTransferencia' => 'Id Descripcion Transferencia',
    ...
    public function search() {
        ...
        $criteria->compare('IdDescripcionTransferencia', $this->IdDescripcionTransferencia);
     ...
     * @return Kitdescripciontransferencia the static model class
     */
