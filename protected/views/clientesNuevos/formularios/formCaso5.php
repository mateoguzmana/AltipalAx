    ...
    <div class="modal-content">
      ...
      <div class="modal-body ">
      	<div class="row">
      		...
      		<div class="col-sm-10">
      			<p class="text-modal-body">El cliente  se encuentre atendido por una zona de ventas del mismo grupo de ventas</p>
      		</div>
      	</div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default btn-small-template" id="cerrarAlertaEnrutar">Cerrar</button>        
      </div>
    </div><!-- modal-content -->
  </div><!-- modal-dialog -->
</div><!-- modal -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <p class="text-modal-body">"Recuerde que el cliente se encuentra atendido por un asesor del mismo de venta" <br/> Desea crear un nuevo establecimiento?</p>
                    </div>
                </div>
