                        ...
                        <div class="tab-content">
                            <div class="widget-bloglist tab-pane active" id="frm-registrar">	              
                                ...
                                <div class="form-group">
                                   ...
                                   <!-- <div class="col-sm-6">
                                        <button type="button" id="cargar-Barrio" class="btn btn-primary" value="Otro barrio" /> 
                                    </div>-->
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="clienteNuevo[telefono1]" id="telefono1" onkeypress="return FilterInput(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="clienteNuevo[correo]" id="email" onblur="validarEmail()">
                            ...
                            <div class="widget-bloglist tab-pane" id="frm-enrutar">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select required="" class="form-control" id="frecuenciaVisita" name="clienteNuevo[frecuenciaVisita]">
                                            <option value="k">Frecuencia</option> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div id=""></div>
                                        <input type="text" id="datepicker-inline" class="form-control" disabled="true"/>
                                    </div>			                  	
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" id="">
                                        <table class="table table-hover" id="Nvisitas">
                                            <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <p class="text-modal-body">El cliente con Nª de Identificacion <b><?php echo $identificacionCliente; ?></b> no existe.<br/> Desea crearlo como cliente nuevo?</p>
                    </div>
                </div>
