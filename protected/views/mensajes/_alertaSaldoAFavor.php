 ...
 <div class="modal fade" id="_alertaRecargarPagina" tabindex="-2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false"> 
    <div class="modal-dialog modal-dialog-message">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary ok" type="button" id="btnConfirmarFaldoAFavor">Aceptar</button>
