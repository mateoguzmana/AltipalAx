              ...
              <tbody>
                <?php $cont=1; foreach ($datos as $item){ ?>
                  ...
                  <tr>
                    ...
                    <?php if($item['txtlote'] == ""){ ?>
                    <th class="actulizarPortafolio cursorpointer"></th>
                    <?php }else{ ?>
                    <th class="actulizarPortafolio cursorpointer" data-variante="<?php echo $item['variante'];?>" ><?php echo $item['txtlote'];?></th>
                    <?php } ?>
                    ...
                    <th class="<?php if($item['codigoTipo']=="KD") echo "btnAdicionarKitDinamico"; else if($item['codigoTipo']=="KV") {  echo "btnAdicionarKitVirtual"; } else{ echo "btnAdicionarProductoDetalleAct"; }?>   cursorpointer text-center" 
