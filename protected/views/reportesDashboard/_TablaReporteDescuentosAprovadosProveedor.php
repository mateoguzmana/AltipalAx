<div class="contentpanel">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
              <input type="button" class="btn btn-primary DescuentosAprobadosPorProveedorExcel" value="Exportar Excel">
                <br>
                <br>
          
            <div style="overflow-y: scroll; min-height: 100%; max-height: 500px; border: solid 2px #eee; padding: 10px;">

                <table  id="DatosDescuentosAprobadosProveedor" class="table table-bordered" style="width: 1500px;">
