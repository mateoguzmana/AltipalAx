<div class="contentpanel">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
              <input type="button" class="btn btn-primary DescuentosPendientesExcel" value="Exportar Excel">
                <br>
                <br>
          
            <div style="overflow-y: scroll; min-height: 100%; max-height: 500px; border: solid 2px #eee; padding: 10px;">

                <table  id="DatosDescuentosPendientes" class="table table-bordered" style="width: 1500px;">
                    ...
                    <thead>
                        <tr style="background-color: #8DB4E2; font-size: 14px;">
                            ...
                            <th class="text-center">Descuento Altipal</th>
                            <th class="text-center">Descuento Proveedor</th>
                            <th class="text-center">Falta por Autorizar</th>
                         </tr>        
                    </thead>
