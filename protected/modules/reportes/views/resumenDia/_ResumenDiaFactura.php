                               ...
                               <div class="table-responsive">
                                 ...
                                 <table class="table table-bordered">
                                   ...
                                   <tr>
                                       ...
                                       <td class="text-center"><?php echo $iteminfo['Plazo'];?></td>
...
<!                                     <td class="text-center"><?php echo $itemDetalle['DsctoLinea']?></td>
                                      ...
                                      <td class="text-center">
                                          <img src="images/kits.png" style="width: 55px; height: 70px;"  class="cursorpointer"  id="<?php echo $itemDetalle['Id'] ?>" onclick="kitsFacturasZona(this.id)" >
                                      </td>
