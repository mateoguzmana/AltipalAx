<div class="panel-heading">
    ...
    <form action="  index.php?r=reportes/ResumenDia/ExportarExcelNotasCredito" method=post name="formulario_notascredito_excel">    
                ...
                <table class="table table-bordered" >
                    ...
                    <tr>   
                        ...
                        <td class="text-center">
                            <img src="images/fotos.png" style="width: 56px; height: 44px;"  class="cursorpointer"  id="<?php echo $iteminfo['IdNotaCredito'] ?>" onclick="FotosZona(this.id)" title="fotos">
