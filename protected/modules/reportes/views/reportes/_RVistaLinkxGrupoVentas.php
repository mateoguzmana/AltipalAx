                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div id="containervistalinkventasvendedorxgrupoventas" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1500px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                    foreach ($reporteventasprovedorxGrupoVentas as $ItemTotales) {
                                                        ?>
                           ...
                           <div style="overflow: scroll">
                            <div class="col-sm-12">
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div id="containercajasxgrupoventas" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1000px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                   $arrayContenedorCajasGrupoVentas = array();
                                                   $anteriorProvedorCaja = "";
                                                   $valorProve = 0;
                                                   $contcajas = 0;
                                                   arsort($reportecajaxGrupoVentas);
                                                   
                                                  /* echo '<pre>';
                                                   print_r($reportecajaxGrupoVentas);*/
                                                   
                                                    foreach ($reportecajaxGrupoVentas as $itemacaja){
                                                         //$contcajas ++;
                                                             ...
                                                             if($contcajas > 0)
                                                                 
                                                               {
                                                                  $provisional = array("total_ventas_porveedor_caja"=>$valorProve,"NombreCuentaProveedor"=>$anteriorProvedorCaja,);
                                                                   ...
                                                                   array_push($arrayContenedorCajasGrupoVentas, $provisional);
                                                                   $valorProve = 0;
                                                    ...
                                                    arsort($arrayContenedorCajasGrupoVentas);
                                                    $contArray=0;
                                                    foreach ($arrayContenedorCajasGrupoVentas as $ItemTotales) {
                                                        if($contArray < 12){
                                                        ?>
                                                        <td class="text-center"><?php echo $ItemTotales['NombreCuentaProveedor'] ?></td>
                                                        <?php
                                                ...
                                                <tr>
                                                   ...
                                                   arsort($reportecajaxGrupoVentas);
                                                    ...
                                                    $contArray=0;
                                                    foreach ($arrayContenedorCajasGrupoVentas as $ItemTotales) {
                                                        $totalcajasgrupoventas = intval($ItemTotales['total_ventas_porveedor_caja']);
                                                          if($contArray < 12){
                                                        ?>
                                                    <td class="text-center"><?php echo $totalcajasgrupoventas ?></td>
                                                        <?php
                                                          }
                                                      $contArray++;    
                                                    }
 ...
 <script>
    ...
    $(document).ready(function(){
        ...
        $('#containervistalinkventasvendedorxgrupoventas').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reporteventasprovedorxGrupoVentas as $item): ?>
...
<?php foreach ($reporteventasprovedorxGrupoVentas as $itemtotal): ?>
...
<?php endforeach; ?>
        ...
        ////Grafica cajas///
         ...
         $('#containercajasxgrupoventas').highcharts({
    chart: {
    type: 'column'
    },
            title: {
...
$arrayContenedorCajasGrupoVentas = array();
                                                   ...
                                                   arsort($reportecajaxGrupoVentas);
                                                    ...
                                                    ///el entra a esta lina de codigo si es solo un proveedor
...
foreach ($arrayContenedorCajasGrupoVentas as $item): ?>
                    <?php if($contArray < 12) ?>
                '<?php echo $item['NombreCuentaProveedor']; ?>',
...
$arrayContenedorCajasGrupoVentas = array();
                                                   ...
                                                   arsort($reportecajaxGrupoVentas);
                                                    ...
                                                    ///entraa esta linea de codigo si el provvedor es uno solo  
                                                    $provisional = array("total_ventas_porveedor_caja"=>$valorProve,"NombreCuentaProveedor"=>$anteriorProvedorCaja,);
                                                    array_push($arrayContenedorCajasGrupoVentas, $provisional);    
...
foreach ($arrayContenedorCajasGrupoVentas as $itemtotal):
    $totalcajasgrupoventas = intval($itemtotal['total_ventas_porveedor_caja']);
    ?>
                        <?php if($contArray < 12){ ?>
    <?php echo $totalcajasgrupoventas ?>,
                        <?php } ?>
<?php $contArray++; endforeach; ?>
                    ]
