        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div id="containerclientesxagencia" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1500px  ! important;">
                            <tr>
                                <td></td>
                                <?php
                                foreach ($reportexClientesxCarteraVencidaXAgencia as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div id="containernoventasxagencia" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px  ! important;">
                            <tr>
                                <td class="text-center"><b>Motivos</b></td>
                                <?php
                                foreach ($reportexClientesxNoventasxAgencia as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <div id="containernotascreditosxagencia" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px;">

                            <?php
                            foreach ($reportexClientesNotaCreditoxAgencia as $ItemTotales) {
                                ?>
                                <tr>
...
<script>
    ...
    $('#containerclientesxagencia').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexClientesxCarteraVencidaXAgencia as $item): ?>
...
<?php foreach ($reportexClientesxCarteraVencidaXAgencia as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containernoventasxagencia').highcharts({
    chart: {
    type: 'pie',
            options3d: {
            enabled: true,
            ...
            type: 'pie',
                    name: 'Clientes',
                    data: [
<?php foreach ($reportexClientesxNoventasxAgencia as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containernotascreditosxagencia').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexClientesNotaCreditoxAgencia as $item): ?>
...
<?php foreach ($reportexClientesNotaCreditoxAgencia as $itemtotal): ?>
