                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div id="containervistalinkventasvendedorxagencia" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1500px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                    foreach ($reporteventasprovedorxAgencia as $ItemTotales) {
                                                        ?>
                           ...
                           <div style="overflow: scroll">
                            <div class="col-sm-12">
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div id="containercajasxagencia" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1000px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                  $arrayContenedorCajasAgencia = array();
                                                  $anteriorProvedorCaja = "";
                                                  $valorProve = 0;
                                                  $contcajas = 0;
                                                  arsort($reportecajaxAgencia);
                                                   
                                                    foreach ($reportecajaxAgencia as $itemacaja){
                                                             ...
                                                             if($contcajas > 0)
                                                                 
                                                               {
                                                                  $provisional = array("total_ventas_porveedor_caja"=>$valorProve,"NombreCuentaProveedor"=>$anteriorProvedorCaja,);
                                                                   ...
                                                                   array_push($arrayContenedorCajasAgencia, $provisional);
                                                                   $valorProve = 0;
                                                    ...
                                                    arsort($arrayContenedorCajasAgencia);
                                                    $contArray=0;   
                                                    foreach ($arrayContenedorCajasAgencia as $ItemTotales) {
                                                        if($contArray < 12){
                                                        ?>
                                                        <td class="text-center"><?php echo $ItemTotales['NombreCuentaProveedor'] ?></td>
                                                        <?php
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                  $arrayContenedorCajasAgenciaTotal = array();
                                                  $anteriorProvedorCajaTotal = "";
                                                  $valorProveTotal = 0;
                                                  $contcajastotal = 0;
                                                  arsort($reportecajaxAgencia);
                                                   
                                                    foreach ($reportecajaxAgencia as $itemacajatotal){
                                                        
                                                        if($itemacajatotal['CodigoUnidadMedida'] != '001'){
                                                             //$contcajas ++;
                                                            $UnidadConversion = ReporteVistaLink::model()->getUnidadConversion($itemacajatotal['CodigoArticulo'],$itemacajatotal['CodigoUnidadMedida'],$itemacajatotal['Agencia']);
                                                            
                                                            foreach ($UnidadConversion as $itemConversion){
                                                            
                                                            $cajasamostrartotal = $itemacajatotal['Cantidad'] / $itemConversion['Factor'];
                                                            
                                                          
                                                            }
                                                            
                                                              
                                                           if($itemacajatotal['NombreCuentaProveedor'] != $anteriorProvedorCajaTotal)
                                                             
                                                            {
                                                             if($contcajastotal > 0)
                                                                 
                                                               {
                                                                  $provisionaltotal = array("total_ventas_porveedor_caja"=>$valorProveTotal,"NombreCuentaProveedor"=>$anteriorProvedorCajaTotal,);
                                                                    
                                                                   array_push($arrayContenedorCajasAgenciaTotal, $provisionaltotal);
                                                                   $valorProveTotal = 0;
                                                                  
                                                               }
                                                            }
                                                          $valorProveTotal = $valorProveTotal + $cajasamostrartotal;
                                                          $anteriorProvedorCajaTotal = $itemacajatotal['NombreCuentaProveedor'];
                                                          $contcajastotal ++;
                                                        }
                                                      }
                                                    //el entra a esta linea de codigo si es solo un proveedor    
                                                    ...
                                                    arsort($arrayContenedorCajasAgenciaTotal);
                                                    $contArrayTotales=0; 
                                                    foreach ($arrayContenedorCajasAgenciaTotal as $ItemTotales) {
                                                      $cajastotalesproveedor=intval($ItemTotales['total_ventas_porveedor_caja']);  
                                                    if($contArrayTotales < 12){
                                                        ?>
                                                    <td class="text-center"><?php echo $cajastotalesproveedor ?></td>
                                                        <?php
                                                        }
                                                      $contArrayTotales++;  
                                                    }
 ...
 <script>
    ...
    $(document).ready(function(){
        ...
        $('#containervistalinkventasvendedorxagencia').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reporteventasprovedorxAgencia as $item): ?>
...
<?php foreach ($reporteventasprovedorxAgencia as $itemtotal): ?>
...
<?php endforeach; ?>
         ...
         $('#containercajasxagencia').highcharts({
    chart: {
    type: 'column'
    },
            title: {
...
foreach ($arrayContenedorCajasAgencia as $item): ?>
                    <?php if($contArray < 12){ ?>
                '<?php echo $item['NombreCuentaProveedor']; ?>',
                    <?php } ?>
...
foreach ($arrayContenedorCajasAgenciaTotal as $itemtotal):
    
     $cajastotalesproveedor=intval($itemtotal['total_ventas_porveedor_caja']);  
    
    ?>
                        
                    <?php if ($contArrayTotales < 12){ ?>    
            <?php echo $cajastotalesproveedor; ?>,
                    <?php } ?>     
<?php $contArrayTotales++; endforeach; ?>
                    ]
