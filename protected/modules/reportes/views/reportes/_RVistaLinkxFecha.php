                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div id="containervistalinkventasvendedorxfecha" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1500px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                    foreach ($reporteventasprovedorxFecha as $ItemTotales) {
                                                        ?>
                           ...
                           <div style="overflow: scroll">
                            <div class="col-sm-12">
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div id="containercajasxafecha" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1000px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                   $arrayContenedorCajasFecha= array();
                                                   $anteriorProvedorCaja = "";
                                                   $valorProve = 0;
                                                   $contcajas = 0;
                                                   arsort($reportecajaxFecha);
                                                   
                                                    foreach ($reportecajaxFecha as $itemacaja){
                                                         //$contcajas ++;
                                                             ...
                                                             if($contcajas > 0)
                                                                 
                                                               {
                                                                  $provisional = array("total_ventas_porveedor_caja"=>$valorProve,"NombreCuentaProveedor"=>$anteriorProvedorCaja,);
                                                                   ...
                                                                   array_push($arrayContenedorCajasFecha, $provisional);
                                                                   $valorProve = 0;
                                                   ...
                                                   array_push($arrayContenedorCajasFecha, $provisional);     
                                                    ...
                                                    arsort($arrayContenedorCajasFecha);
                                                    $contArray=0;
                                                    
                                                    foreach ($arrayContenedorCajasFecha as $ItemTotales) {
                                                        if($contArray < 12){
                                                        ?>
                                                        <td class="text-center"><?php echo $ItemTotales['NombreCuentaProveedor'] ?></td>
                                                        <?php
                                                ...
                                                <tr>
                                                   ...
                                                   arsort($reportecajaxFecha);
                                                    ...
                                                    foreach ($arrayContenedorCajasFecha as $ItemTotales) {
                                                        $totalcajafecha = intval($ItemTotales['total_ventas_porveedor_caja']);
                                                        if($contArray < 12){
                                                        ?>
                                                    <td class="text-center"><?php echo $totalcajafecha ?></td>
                                                        <?php
                                                       }
                                                       $contArray++;
                                                    }
 ...
 <script>
    ...
    $(document).ready(function(){
        ...
        $('#containervistalinkventasvendedorxfecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reporteventasprovedorxFecha as $item): ?>
...
<?php foreach ($reporteventasprovedorxFecha as $itemtotal): ?>
...
<?php endforeach; ?>
        ...
        $('#containercajasxafecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
...
foreach ($arrayContenedorCajasFecha as $item): ?>
                    <?php if($contArray < 12){ ?>
                '<?php echo $item['NombreCuentaProveedor']; ?>',
                    <?php } ?>
...
foreach ($arrayContenedorCajasFecha as $itemtotal): 
    $totalcajafecha = intval($itemtotal['total_ventas_porveedor_caja']);
    ?>
                      <?php  if($contArray < 12){ ?>
    <?php echo $totalcajafecha ?>,
                      <?php } ?>
<?php $contArray++; endforeach; ?>
                    ]
