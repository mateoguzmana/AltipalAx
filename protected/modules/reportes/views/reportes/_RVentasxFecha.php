                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div id="containerventasxFecha" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1500px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                    foreach ($reporteventasxfecha as $ItemTotales) {
                                                        ?>
                           ...
                           <div style="overflow: scroll">
                            <div class="col-sm-12">
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div id="containerventasproductosventidosxFecha" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1000px  ! important;">
                                                <tr>
                                                    ...
                                                    <?php
                                                    foreach ($reportexfechaproductosvendidos as $ItemTotales) {
                                                        ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-danger">
                                    ...
                                    <div class="panel-body">
                                        <div id="containerproveedorxventasxFecha" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1000px;">
                                                <tr>
                                                    ...
                                                    <?php
                                                    foreach ($reportexfechaventasproveedor as $ItemTotales) {
                                                        ?>
...
//    });
            ...
            $('#containerventasxFecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reporteventasxfecha as $item): ?>
...
<?php foreach ($reporteventasxfecha as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            ////Grafica productos mas vendedios///
             ...
             $('#containerventasproductosventidosxFecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexfechaproductosvendidos as $item): ?>
...
<?php foreach ($reportexfechaproductosvendidos as $itemtotal): ?>
...
<?php endforeach; ?>
     ...
     $('#containerproveedorxventasxFecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexfechaventasproveedor as $item): ?>
...
<?php foreach ($reportexfechaventasproveedor as $itemtotal): ?>
