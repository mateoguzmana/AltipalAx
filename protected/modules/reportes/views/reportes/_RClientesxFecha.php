        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div id="containerclientesxfecha" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1500px  ! important;">
                            <tr>
                                <td></td>
                                <?php
                                foreach ($reportexClientesxCarteraVencidaXFecha as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div id="containernoventasxfecha" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px  ! important;">
                            <tr>
                                <td class="text-center"><b>Motivos</b></td>
                                <?php
                                foreach ($reportexClientesxNoventasxFecha as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <div id="containernotascreditosxfecha" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px;">
                            <?php
                            foreach ($reportexClientesNotaCreditoxFecha as $ItemTotales) {
                                ?>
                                <tr>
...
<script>
    ...
    $('#containerclientesxfecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexClientesxCarteraVencidaXFecha as $item): ?>
...
<?php foreach ($reportexClientesxCarteraVencidaXFecha as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containernoventasxfecha').highcharts({
    chart: {
    type: 'pie',
            options3d: {
            enabled: true,
            ...
            type: 'pie',
                    name: 'Clientes',
                    data: [
<?php foreach ($reportexClientesxNoventasxFecha as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containernotascreditosxfecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexClientesNotaCreditoxFecha as $item): ?>
...
<?php foreach ($reportexClientesNotaCreditoxFecha as $itemtotal): ?>
