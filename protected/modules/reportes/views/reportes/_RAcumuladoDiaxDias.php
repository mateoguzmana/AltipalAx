...
<div class="row">
    <div class="col-sm-6">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div id="containerFechaPedido" style="position:relative; min-width:200px; max-width:700px; width: 100%;"></div>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tr>
                            <td class="text-center">Canal</td>
                            <?php
                            foreach ($reportexfechapedido as $ItemTotales) {
                                ?>
    ...
    <div class="col-sm-6">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div id="containerRecaudosxFecha" style="position:relative; min-width:200px; max-width:700px; width: 100%;"></div>
                <div class="table-responsive">
                    <table class="table table-bordered" style="width: 462px  ! important;">
                        <tr>
                            <td class="text-center">Canal</td>
                            <?php
                            foreach ($reportexfecharecaudo as $ItemTotales) {
                            ?>
                            <td class="text-center"><?php echo $ItemTotales['NombreCanal'] ?></td>
                            <?php
                            }
...
<div class="row">     
    <div class="col-sm-6">
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                <div id="containerClientesNuevosxFecha" style="position:relative; min-width:200px; max-width:700px; width: 100%;"></div>
                <div class="table-responsive">
                    <table class="table table-bordered" style="width: 462px;">
                        <tr>
                            <td></td>
                            <?php
                              foreach ($reportexfechaclientenuevos as $ItemTotales) {
                             ?>
                            <td class="text-center"><?php echo $ItemTotales['NombreCanal'] ?></td>
                            <?php
                              }
    ...
    <div class="col-sm-6">
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                 <div id="containerEfectividadFecha" style="position:relative; min-width:200px; max-width:700px; width: 100%;"></div>
                                   <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <tr>
                                                <td class="text-center">Prcentaje</td> 
                                              <?php foreach ($reportexafechaefectividad as $itemCanal):
...
<script>
    ...
    $("#datepicker").datepicker();
            ...
            $('#containerFechaPedido').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexfechapedido as $item): ?>
...
<?php foreach ($reportexfechapedido as $itemtotal): ?>
...
<?php endforeach; ?>
    ...
    //graficas de recaudos x fecha
     ...
     $('#containerRecaudosxFecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexfecharecaudo as $item): ?>
                '<?php echo $item['NombreCanal']; ?>',
<?php endforeach; ?>
            ]
            },
...
<?php foreach ($reportexfecharecaudo as $itemtotal): ?>
...
<?php endforeach; ?>
    ...
    //grafica de cientes nuevos x zona
      ...
      $('#containerClientesNuevosxFecha').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexfechaclientenuevos as $item): ?>
                '<?php echo $item['NombreCanal']; ?>',
<?php endforeach; ?>
            ]
            },
...
<?php foreach ($reportexfechaclientenuevos as $itemtotal): ?>
...
<?php endforeach; ?>
    ...
    $('#containerEfectividadFecha').highcharts({
            chart: {
                type: 'column'
            },
            title: {
            ...
            xAxis: {
                categories: [
               <?php foreach ($reportexafechaefectividad as $item):?>
                '<?php echo $item['NombreCanal']; ?>',
               <?php  endforeach; ?>
                ]
            },
            ...
            series: [{
                    ...
                    color: '#FFA200',
                    data: [
<?php foreach ($reportexafechaefectividad as $itemtotal): ?>
