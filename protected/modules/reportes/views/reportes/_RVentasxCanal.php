    ...
    <div class="col-sm-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div id="containerventasxAgencia" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                <div class="table-responsive">
                    <table class="table table-bordered" style="width: 1500px  ! important;">
                        <tr>
                            <td></td>
                            <?php
                            foreach ($reportexClientesCompradoresxCanal as $ItemTotales) {
                                ?>
...
<div class="row"> 
    ...
    <div class="col-sm-12">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div id="containerventasproductosventidosxAgencia" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                <div class="table-responsive">
                    <table class="table table-bordered" style="width: 1000px  ! important;">
                        <tr>
                            ...
                            <?php
                            foreach ($reportexClientesxProductosVendidosxCanal as $ItemTotales) {
                                ?>
...
<div class="row">  
    ...
    <div class="col-sm-12">
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <div id="containerproveedorxventasxAgencia" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                <div class="table-responsive">
                    <table class="table table-bordered" style="width: 1000px;">
                        <tr>
                            ...
                            <?php
                            foreach ($reportexClientesxVantasPorProveedorXCanal as $ItemTotales) {
                                ?>
...
//    });
    ...
    var Fecha = $('#datepicker').val();        
            ...
            $('#containerventasxAgencia').highcharts({
    chart: {
    type: 'column'
    },
            title: {
...
<?php foreach ($reportexClientesCompradoresxCanal as $item): ?>
...
<?php foreach ($reportexClientesCompradoresxCanal as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containerventasproductosventidosxAgencia').highcharts({
    chart: {
    type: 'column'
    },
            title: {
...
<?php foreach ($reportexClientesxProductosVendidosxCanal as $item):
    ?>
...
<?php foreach ($reportexClientesxProductosVendidosxCanal as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containerproveedorxventasxAgencia').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexClientesxVantasPorProveedorXCanal as $item): ?>
...
<?php foreach ($reportexClientesxVantasPorProveedorXCanal as $itemtotal): ?>
