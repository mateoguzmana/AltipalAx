                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1500px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                    foreach ($reportexagenciacompradores as $ItemTotales) {
                                                        ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1000px  ! important;">
                                                <tr>
                                                    ...
                                                    <?php
                                                    foreach ($reportexagenciaproductosvendidos as $ItemTotales) {
                                                        ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1000px;">
                                                <tr>
                                                    ...
                                                    <?php
                                                    foreach ($reportexagenciaventasxproveedor as $ItemTotales) {
                                                        ?>
...
//    });
    ...
    type: 'column'
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexagenciacompradores as $item): ?>
...
<?php foreach ($reportexagenciacompradores as $itemtotal): ?>
...
<?php endforeach; ?>
    ...
    type: 'column'
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexagenciaproductosvendidos as $item): ?>
...
<?php foreach ($reportexagenciaproductosvendidos as $itemtotal): ?>
...
<?php endforeach; ?>
    ...
    type: 'column'
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexagenciaventasxproveedor as $item): ?>
...
<?php foreach ($reportexagenciaventasxproveedor as $itemtotal): ?>
