        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div id="containerventasxProveedor" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1500px  ! important;">
                            <tr>
                                <td></td>
                                <?php
                                foreach ($reportexproveedorcompradores as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div id="containerventasproductosventidosxProveedor" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px  ! important;">
                            <tr>
                                ...
                                <?php
                                foreach ($reportexproveedorproductosvendidos as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <div id="containerproveedorxventasxProveedor" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px;">
                            <tr>
                                ...
                                <?php
                                foreach ($reportexproveedorventasxproveedor as $ItemTotales) {
                                    ?>
...
//    });
    $("#selectchosegrupventas").chosen();
       ...
       var Fecha = $('#datepicker').val();      
            ...
            $('#containerventasxProveedor').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexproveedorcompradores as $item): ?>
...
<?php foreach ($reportexproveedorcompradores as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containerventasproductosventidosxProveedor').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexproveedorproductosvendidos as $item): ?>
...
<?php foreach ($reportexproveedorproductosvendidos as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containerproveedorxventasxProveedor').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexproveedorventasxproveedor as $item): ?>
...
<?php foreach ($reportexproveedorventasxproveedor as $itemtotal): ?>
