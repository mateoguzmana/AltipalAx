        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div id="containerclientesxcanal" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1500px  ! important;">
                            <tr>
                                <td></td>
                                <?php
                                foreach ($reportexClientesxCarteraVencidaXCanal as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div id="containernoventasxcanal" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px  ! important;">
                            <tr>
                                <td class="text-center"><b>Motivos</b></td>
                                <?php
                                foreach ($reportexClientesxNoventasxCanal as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <div id="containernotascreditosxcanal" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px;">

                            <?php
                            foreach ($reportexClientesNotaCreditoxCanal as $ItemTotales) {
                                ?>
                                <tr>
...
<script>
    ...
    $('#containerclientesxcanal').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexClientesxCarteraVencidaXCanal as $item): ?>
...
<?php foreach ($reportexClientesxCarteraVencidaXCanal as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containernoventasxcanal').highcharts({
    chart: {
    type: 'pie',
            options3d: {
            enabled: true,
            ...
            type: 'pie',
                    name: 'Clientes',
                    data: [
<?php foreach ($reportexClientesxNoventasxCanal as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containernotascreditosxcanal').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexClientesNotaCreditoxCanal as $item): ?>
...
<?php foreach ($reportexClientesNotaCreditoxCanal as $itemtotal): ?>
