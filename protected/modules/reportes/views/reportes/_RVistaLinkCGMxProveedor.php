                                        ...
                                        <table class="table table-bordered">
                                            <tr>
                                             ...
                                             <?php 
                                                ...
                                                $total = 0;
                                                $cont = 0;
                                                arsort($CategoriaxProveedor);
                                                for($i=0;$i<count($CategoriaxProveedor);$i++){
                                                    if($CategoriaxProveedor[$i]['CodigoGrupoCategoria']==$CategoriaxProveedor[$i+1]['CodigoGrupoCategoria']){
                                                        if($total==0){
                                                            $total=$CategoriaxProveedor[$i]['TotalPrecioNeto'];
                                                        }
                                                        $total +=$CategoriaxProveedor[$i+1]['TotalPrecioNeto'];
                                                        $nombre = $CategoriaxProveedor[$i]['CodigoGrupoCategoria'];
                                            ...
                                            <tr>
                                               ...
                                               $contCategoriaCaja = 0;
                                                    arsort($CategoriaxProveedor);
                                                    foreach ($CategoriaxProveedor as $itemaCategoriacaja){
                                        ...
                                        <table class="table table-bordered">
                                            <tr>
                                                ...
                                                for($i=0;$i<count($Gp);$i++){
                                                    if($Gp[$i]['Agrupo']==$Gp[$i+1]['Agrupo']){
                                                        if($totalValorGrupo==0){
                                                            $totalValorGrupo=$Gp[$i]['ValorTotalCategoria'];
                                                        }
                                                        if($totalcajas == 0){
                                                          $totalcajas=$Gp[$i]['Cajas'];  
                                                        }
                                                        $totalValorGrupo +=$Gp[$i+1]['ValorTotalCategoria'];
                                                        $totalcajas+=$Gp[$i+1]['Cajas'];
                                                        $Grupo = $Gp[$i]['Agrupo'];
                                                        $arrayGrupo[$contGrupo] = array('ValorTotalGrupo'=>$totalValorGrupo,'Grupo'=>$Grupo , 'TotalCajasGrupo'=>$totalcajas);
                                                    }else{
                                                        $contGrupo++;
                                                        $totalValorGrupo = 0;
                                                        $totalcajas=0;
