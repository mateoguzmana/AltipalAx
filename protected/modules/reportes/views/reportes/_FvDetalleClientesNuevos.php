...
<div class="panel-heading">
    <br> 
    <div align="center">
        <a  href="javascript:clientesnuevos();"><img style="width: 40px; height: 40px; float:left; margin-left: 20px;"  src="images/atras.png" title="Atra"></a>
        <h2>
            <b>
                Clientes Nuevos
            </b>
    ...
    <form action="index.php?r=reportes/Reportes/ExportarExcelClientesNuevos" method=post name="formulario_clientesnuevos_excel">     
