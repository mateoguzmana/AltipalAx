        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div id="containerventasxZona" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1500px  ! important;">
                            <tr>
                                <td></td>
                                <?php
                                foreach ($reporteventasxzona as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div id="containerventasproductosventidosxzona" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px  ! important;">
                            <tr>
                                ...
                                <?php
                                foreach ($reportexzonaproductosvendidos as $ItemTotales) {
                                    ?>
    ...
    <div style="overflow: scroll">
        <div class="col-sm-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <div id="containerproveedorxventasxzona" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered" style="width: 1000px;">
                            <tr>
                                ...
                                <?php
                                foreach ($reportexzonaventasproveedor as $ItemTotales) {
                                    ?>
...
//    });
    $("#selectchosegrupventas").chosen();
      ...
      var Fecha = $('#datepicker').val();        
            ...
            $('#containerventasxZona').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reporteventasxzona as $item): ?>
...
<?php foreach ($reporteventasxzona as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containerventasproductosventidosxzona').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexzonaproductosvendidos as $item): ?>
...
<?php foreach ($reportexzonaproductosvendidos as $itemtotal): ?>
...
<?php endforeach; ?>
            ...
            $('#containerproveedorxventasxzona').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reportexzonaventasproveedor as $item): ?>
...
<?php foreach ($reportexzonaventasproveedor as $itemtotal): ?>
