                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div id="containervistalinkventasvendedorxcanal" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1500px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                    foreach ($reporteventasprovedorxCanal as $ItemTotales) {
                                                        ?>
                           ...
                           <div style="overflow: scroll">
                            <div class="col-sm-12">
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div id="containercajasxcanal" style="min-width: 310px; width: 1000px; height: 400px; margin: 0 auto"></div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="width: 1000px  ! important;">
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                  $arrayContenedorCajasCanal = array();
                                                  $anteriorProvedorCaja = "";
                                                  $valorProve = 0;
                                                  $contcajas = 0;
                                                  arsort($reportecajaxCanal);
                                                   
                                                    foreach ($reportecajaxCanal as $itemacaja){
                                                             ...
                                                             if($contcajas > 0)
                                                                 
                                                               {
                                                                  $provisional = array("total_ventas_porveedor_caja"=>$valorProve,"NombreCuentaProveedor"=>$anteriorProvedorCaja,);
                                                                   ...
                                                                   array_push($arrayContenedorCajasCanal, $provisional);
                                                                   $valorProve = 0;
                                                    ...
                                                    arsort($arrayContenedorCajasCanal);
                                                    $contArray=0;   
                                                    foreach ($arrayContenedorCajasCanal as $ItemTotales) {
                                                         if($contArray < 12){
                                                        ?>
                                                        <td class="text-center"><?php echo $ItemTotales['NombreCuentaProveedor'] ?></td>
                                                        <?php
                                                ...
                                                <tr>
                                                   ...
                                                   arsort($reportecajaxCanal);
                                                    ...
                                                    foreach ($arrayContenedorCajasCanal as $ItemTotales) {
                                                        $totacajacanal = intval($ItemTotales['total_ventas_porveedor_caja']);
                                                        if($contArray < 12){
                                                        ?>
                                                    <td class="text-center"><?php echo $totacajacanal ?></td>
                                                        <?php
                                                        }
                                                      $contArray++;  
                                                    }
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="form-group">
                                ...
                                <div>
                                    <select id="selectAgencia" name="Agencia" class="form-control chosen-select onchageGruposVentasVistaLink" data-placeholder="Seleccione una agencia">
                                        <option value=""></option>
                                        <?php
                       ...
                       <div class="col-md-3 text-center">
                            <div class="form-group">
                                <label>Fecha</label>
                                <div>
                                    <input style="height: 36px;" type="text"  class="form-control GenrarRepotFechaVistaLink"  id="datepickerVistaLink" value = "<?php echo date('Y-m-d') ?>"/>
                                </div>
                            </div>
                        </div>
                       <div class="col-md-3 text-center">
                            <div class="form-group">
                                ...
                                <div>
                                    <select id="selectProveedor" name="Proveedor" class="form-control chosen-select GenrarReporteProveedorVentasVistaLink" data-placeholder="Seleccione un proveedor">
                                        <option value=""></option>
                                        <?php
                       ...
                       <div class="col-md-3 text-center">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="form-group">
                                <label>Grupos</label>
                                <div>
                                    <select id="selectGrupos" name="Grupo" class="form-control chosen-select GenrarReporteGruposVentasVistaLink" data-placeholder="Seleccione un grupo">
                                        <option value=""></option>
 ...
 <script>
    ...
    $(document).ready(function(){
       ...
       var FechaCat =  $('#datepickerVistaLink').val();
        ...
        $('#containervistalinkventasvendedorxcanal').highcharts({
    chart: {
    type: 'column'
    },
            title: {
            ...
            xAxis: {
            categories: [
<?php foreach ($reporteventasprovedorxCanal as $item): ?>
...
<?php foreach ($reporteventasprovedorxCanal as $itemtotal): ?>
...
<?php endforeach; ?>
        ...
        $('#containercajasxcanal').highcharts({
    chart: {
    type: 'column'
    },
            title: {
...
foreach ($arrayContenedorCajasCanal as $item): ?>
                    <?php if($contArray < 12){ ?>
                '<?php echo $item['NombreCuentaProveedor']; ?>',
                    <?php } ?>
...
foreach ($arrayContenedorCajasCanal as $itemtotal): 
    $totacajacanal = intval($itemtotal['total_ventas_porveedor_caja']);
    ?>
                       <?php if($contArray < 12){ ?>
      <?php echo $totacajacanal; ?>,
                         <?php } ?>
<?php $contArray++; endforeach; ?>
                    ]
