                ...
                foreach ($InfoXMLDetail as $Itemdetail) {
                    ...
                    if ($Itemdetail['CodigoTipo'] == "KD" || $Itemdetail['CodigoTipo'] == "KV") {
                        ...
                        foreach ($InfoXMLDetailKD as $itemKit) {
                            ...
                            $totalkit = $Itemdetail['Cantidad'] ;//5
...
$cont = 0;
               ...
               /* foreach ($CodCuentaBancariaChequeConsignacion as $codigoCuentaBancaria) {
                ...
                foreach ($CodCuentaBancariaChequeConsignacion as $codigoCuentaBancaria) {
                    ...
                    foreach ($DetalleReciboChequeConsignacionDetalle[$ContDetalle] as $item) {
            ...
            foreach ($InforChequePosEncabe as $itemChequePosFechado) {
                ...
                if ($itemChequePosFechado['Posfechado'] == 1) {
                    ...
                    foreach ($InfoChquePosfechadoDetalle as $itemDetalle) {
                        ...
                        $xml .= '<Detail>';
                        $xml .= '<AccountNumPostf>' . $cuentaclienteFactura['CuentaCliente'] . '</AccountNumPostf>';
    ...
    public function createClienteNuevo($cuentaCliente, $agencia) {
        ...
        foreach ($datos as $item) {
          ...
          //$cuentaCliente, $identificacion, $nombre, $razonSocial, $direccion, $telefono, $telefonoMovil, $email, $estado, $codigoCadena, $codigoBarrio, $codigoPostal, $latitud, $longitud, $agencia
            ServiceAltipal::model()->InsertClienteNuevo($item['ArchivoXml'], $item['Identificacion'], $item['Nombre'], $item['RazonSocial'], $item['Direccion'], $item['Telefono'], $item['TelefonoMovil'], 
              $item['Email'], 'No', $item['CodCadenadeEmpresa'], $item['CodBarrio'], $item['CodigoPostal'], $item['Latitud'], $item['Longitud'], $agencia);
            ...
            ServiceAltipal::model()->InsertClienteNuevoRuta($item['CodZonaVentas'], $item['ArchivoXml'], $item['NumeroVisita'], $item['Posicion'], $item['ZonaLogistica'], '0', '0', '0', '022', '0', '0', '005', 
              $CodigoGrupoDescuentoLineaVenta, $CodigoGrupoDescuentoMultilineaVenta, '', $CodigoGrupoPrecioVenta, $agencia);
        }
    }
